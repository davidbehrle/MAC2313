...
\end{center}
\begin{shaded}
    \noindent\bf{\underline{Equation of a Sphere}}
    \vspace{2mm}\\
...
\begin{shaded}
    \noindent\bf{\underline{Definition}}
    \vspace{2mm}\\
...
\begin{shaded}
    \noindent\bf{\underline{Properties of the Dot Product}}
    \vspace{2mm}\\
...
\begin{shaded}
    \noindent\bf{\underline{Theorem:} Orthogonal Vectors}
    \vspace{2mm}\\
